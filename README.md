...
### 2) Run the following command for execution (Qwen Coder2.5- 1.5B model- performed best)- ghsa_test
  - python3 scripts/eval.py --config configs/eval.yaml'
...
## Notes
Our experiments are conducted in the same environment and setup . Detailed experimental results are included in our paper. For SOTA is in script folder.
